...
import tshirtImg1 from '../../assest/womens-fashion/saree/saree1.jpg'; // Replace with actual image paths
import tshirtImg2 from '../../assest/womens-fashion/saree/saree2.jpg';
import tshirtImg3 from '../../assest/womens-fashion/saree/saree3.jpg';
import tshirtImg4 from '../../assest/womens-fashion/saree/saree4.jpg';
import tshirtImg5 from '../../assest/womens-fashion/saree/saree5.jpg';
import tshirtImg6 from '../../assest/womens-fashion/saree/saree6.jpg';
    ...
    <div className="container mx-auto mt-8 mb-16">
      <div className="max-w-screen-xl mx-auto">
        <div className="bg-white border-t-4 border-b-4 border-gray-400 px-6 py-4 rounded-lg shadow-md text-center">
          <h2 className="text-4xl font-bold text-gray-600">Saree Collection</h2>
        </div>
